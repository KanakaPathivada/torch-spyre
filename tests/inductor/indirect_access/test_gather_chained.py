...
class TestGatherComposedChainsAndEndToEndPipelines:
    ...
    def test_two_sequential_gathers(self):
    ...
    def test_gather_then_gather_on_output(self):
    ...
    def test_gather_then_matmul(self):
    ...
    def test_gather_then_layer_norm(self):
    ...
    def test_gather_add_residual(self):
    ...
    def test_gather_split_rope_apply(self):
    ...
    def test_gather_two_tables_add(self):
    ...
    def test_gather_then_scatter_add(self):
        ...
        compare_with_cpu(
            lambda w, i: w[i], expert_w, ids, atol=_ATOL_F16, rtol=_ATOL_F16
        )
    ...
    def test_chunk_gather_cos_sin(self):
    ...
    def test_split_gather_qkv(self):
    ...
    def test_chunked_kv_prefill(self):
    ...
    def test_rope_gather_broadcast(self):
    ...
    def test_chunk_then_reduce(self):
    ...
    def test_gather_unbind_stack(self):
    ...
    def test_chunked_decode_iter(self):
    ...
    def test_chunk_gather_parallel_k_v(self):
    ...
    def test_gather_reshape_chunk(self):
    ...
    def test_gather_split_apply_merge(self):
    ...
    def test_e2e_decode_token_lookup(self):
    ...
    def test_e2e_prefill_embed_lookup(self):
        ...
        compare_with_cpu(
            lambda v, i: v[i], vocab, tok_ids, atol=_ATOL_F16, rtol=_ATOL_F16
        )

    def test_e2e_decode_single_step(self):
    ...
    def test_e2e_batch_decode(self):
        ...
        compare_with_cpu(lambda kv, s: kv[s], kv, slots, atol=_ATOL_F16, rtol=_ATOL_F16)

    def test_e2e_prefill_kv_fill(self):
        ...
        compare_with_cpu(
            lambda kv, p: kv[p], cache, pos, atol=_ATOL_F16, rtol=_ATOL_F16
        )

    def test_e2e_rope_gather(self):
    ...
    def test_e2e_kv_decode_extend(self):
        ...
        compare_with_cpu(
            lambda kv, p: kv[p], cache, all_pos, atol=_ATOL_F16, rtol=_ATOL_F16
        )

    def test_e2e_logit_slice(self):
    ...
    def test_e2e_beam_reorder(self):
    ...
    def test_e2e_continuous_batch(self):
        ...
        compare_with_cpu(
            lambda x, i: x[i], kv, all_slots, atol=_ATOL_F16, rtol=_ATOL_F16
        )

    def test_e2e_speculative_token(self):
    ...
    def test_e2e_paged_gqa_decode(self):
        ...
        slots = torch.randint(0, 512, (32,), dtype=torch.int32)
        compare_with_cpu(lambda x, i: x[i], kv, slots, atol=_ATOL_F16, rtol=_ATOL_F16)

    def test_e2e_chunked_prefill_then_decode(self):
        ...
        compare_with_cpu(fn, kv, decode_idx, atol=_ATOL_F16, rtol=_ATOL_F16)

    def test_e2e_full_pipeline_bfloat16(self):
    ...
    def test_rope_interleaved_gptj_style(self):
        ...
        compare_with_cpu(fn, cos, sin, q, pos, atol=_ATOL_F32, rtol=_ATOL_F32)

    def test_rope_neox_qk_both(self):
        ...
        compare_with_cpu(fn, cos_sin, q, k, pos, atol=_ATOL_F16, rtol=_ATOL_F16)

    def test_rope_interleaved_separate_cos_sin_caches(self):
        ...
        compare_with_cpu(fn, cos, sin, q, k, pos, atol=_ATOL_F16, rtol=_ATOL_F16)
