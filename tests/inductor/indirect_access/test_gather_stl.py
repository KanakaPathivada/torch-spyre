...
class TestGatherSpyreTensorLayoutAnnotation:
    ...
    def test_stl_2d_int64_idx(self, execution_mode):
    ...
    def test_stl_interior_dim_no_stl_needed(self, execution_mode):
    ...
    def test_stl_with_named_dims(self, execution_mode):
    ...
    def test_stl_dynamic_compile(self, execution_mode):
    ...
    def test_stl_with_lx_planning(self, execution_mode):
    ...
    def test_stl_4arg_kv_exact_paged(self, execution_mode):
    ...
    def test_stl_4arg_gqa_h8_d128(self, execution_mode):
    ...
    def test_stl_4arg_mqa_h1(self, execution_mode):
    ...
    def test_stl_4arg_bfloat16(self, execution_mode):
    ...
    def test_stl_4arg_named_dims_combo(self, execution_mode):
    ...
    def test_stride_exact_llama3_embed(self, execution_mode):
    ...
    def test_stride_exact_rope_cache(self, execution_mode):
    ...
    def test_stride_exact_bfloat16_kv(self, execution_mode):
    ...
    def test_stride_exact_non_contiguous_t(self, execution_mode):
